...
y2 = np.cos(x2+delta) - np.cos(x2)

y1_new = (np.cos(x1+delta)**2 - 1 + np.sin(x1)**2)/(np.cos(x1+delta)+np.cos(x1))
y2_new = (np.cos(x2+delta)**2 - 1 + np.sin(x2)**2)/(np.cos(x2+delta)+np.cos(x2))
